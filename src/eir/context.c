...
{
    /*
     * S13 is served only when eir.freeDiameter is configured, either as
     * a freeDiameter configuration file or as the inline identity, realm
     * and listen_on set. Without it the EIR serves N5g-eir only.
     */
